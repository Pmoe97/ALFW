...
// (not initWorldState()) is used deliberately: this bundle runs in a browser/
...
async function main() {
  ...
  void world; // constructed to prove createWorldState() works standalone; nothing dispatches into it here
